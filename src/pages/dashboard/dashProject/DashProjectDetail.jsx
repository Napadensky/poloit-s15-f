...
const DashProjectDetail = () => {
  return (
    <div className='m-4 gap-3 flex flex-col lg:flex-row lg:justify-around align-middle'>
      <div className='flex flex-col content-center gap-3 lg:w-5/12' >
        <img
          src={project}
          alt='Imagen representativa del proyecto'
          className='h-52 w-80 lg:w-[34rem] lg:h-auto rounded-xl object-cover'
        />
        ...
        <div className='flex flex-col gap-3 lg:w-3/12'>
            ...
            <button className='hidden lg:flex justify-around rounded-xl bg-stone-200 py-5 text-base font-semibold text-neutral-300'>
            <img src={user} />
            Squad 4
            <img src={chevron} />
            </button>
